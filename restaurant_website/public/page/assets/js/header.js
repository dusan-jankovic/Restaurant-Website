...
var closeIcon = notify.querySelector('p').querySelector('#close')
 ...
 closeIcon.onclick = () => {
   ...
   if(document.getElementsByClassName("slide-show")[0] != undefined){
   document.getElementsByClassName("slide-show")[0].style.transition = '.65s margin-top'
   document.getElementsByClassName("slide-show")[0].style.marginTop = '0.5px'
   }
 }
