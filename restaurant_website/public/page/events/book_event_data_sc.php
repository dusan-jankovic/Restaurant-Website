<?php
  ...
  //only when $len2 == $len it means that there is no errors
    if($len2 == $len){
     $sql = "INSERT INTO book_event_sc (first_name, last_name, email, phone, company, event_type, event_date, event_start_time, event_end_time, number_of_people, additional_info)
