...
<html lang="en" dir="ltr">
  <head>
    ...
    <meta name="description" content="Mexican Restaurant">
  ...
  <body>
    <header>
            ...
            <li class='li-dropdown'>
               Menus<i class="fa fa-angle-down"></i>
                 <ul class="sub-ul">
                   ...
                   <li><a href="">Los Angeles Brunch</a></li>
      ...
      <!-- nav bar for small devices - Begin -->
      ...
      <!-- nav bar for small devices - End -->
      <div class='header-hack' style='padding:40px;'></div>
    </header>
    ...
    <footer>
      ...
      <div class="find-us">
        ...
        <button type='button' class='reservation-button'>Join our newsletter</button>
      </div>
    </footer>
